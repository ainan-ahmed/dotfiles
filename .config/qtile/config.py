...
keys = [
    ...
    Key([mod], "grave", lazy.layout.next(),
    ...
    Key([mod, "shift"], "r", lazy.reload_config(), lazy.spawn(
        notify_cmd + ' "Configuration Reloaded!"'), desc="Reload the config"),
    ...
    Key([mod, "shift"], "e", lazy.shutdown(), lazy.spawn(
        notify_cmd + ' "Exiting Qtile..."'), desc="Shutdown Qtile"),

    # Key([mod], "r", lazy.spawncmd(), desc="Spawn a command using a prompt widget"),

    Key([mod], "d", lazy.spawn(rofi_drun),
        desc="run rofi as dmenu"),

    # Lockscreen
    Key([mod], "period", lazy.spawn(options.lock_screen), desc="Launch the lockscreen."),
